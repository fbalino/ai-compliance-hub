...
const LAWS: {
  ...
  { slug: "colorado-ai-act", flag: Mountain, name: "Colorado AI Act", shortName: "CO SB 24-205 (amended by SB 26-189)", jurisdiction: "Colorado (statewide)", effectiveDate: "January 1, 2027", focus: "High-risk AI in consequential decisions", scope: "Any deployer/developer of AI making consequential decisions affecting CO consumers", trigger: "Consequential decision in 8 domains (employment, credit, healthcare, housing, etc.)", mainObligation: "Impact assessment, consumer disclosures, human review right, governance program", penalty: "$20,000 per violation", enforcement: "Colorado Attorney General", privateAction: false, keyColor: "blue" },
...
const TABLE_ROWS = [
  ...
  { label: "In effect since", values: ["January 1, 2027 (amended by SB 26-189)", "July 5, 2023", "January 1, 2020", "January 1, 2026"] },
