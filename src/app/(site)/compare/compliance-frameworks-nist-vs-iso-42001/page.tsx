    ...
    <>
      ...
      <div className="rg-page-head">
        <div className="rg-container" style={{ maxWidth: 1100 }}>
          ...
          <h1>NIST AI RMF vs. ISO/IEC 42001</h1>
          ...
          <div style={{ marginTop: 16, display: "flex", flexWrap: "wrap", gap: 8 }}>
            <Link href="/blog/nist-ai-rmf-explainer-for-compliance-teams" className="rg-btn rg-btn-outline" style={{ fontSize: 13 }}>NIST AI RMF Explainer &rarr;</Link>
            <Link href="/compare/colorado-vs-eu-ai-act" className="rg-btn rg-btn-outline" style={{ fontSize: 13 }}>Colorado vs. EU AI Act &rarr;</Link>
          </div>
        </div>
      </div>
      ...
      <div className="rg-page-body">
        <div className="rg-container" style={{ maxWidth: 1100 }}>
          ...
          <div className="rg-scard-grid" style={{ marginBottom: 48 }}>
            <div className="rg-scard" style={{ borderColor: "rgba(37,99,235,0.25)", background: "rgba(37,99,235,0.04)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                ...
                <span style={{ marginLeft: "auto", fontSize: 11, fontFamily: "monospace", color: "#60a5fa" }}>NIST AI 100-1</span>
              </div>
            ...
            <div className="rg-scard" style={{ borderColor: "rgba(147,51,234,0.25)", background: "rgba(147,51,234,0.04)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                ...
                <span style={{ marginLeft: "auto", fontSize: 11, fontFamily: "monospace", color: "#9333ea" }}>ISO 42001</span>
              </div>
          ...
          <div className="rg-cta-banner" style={{ marginTop: 48, flexDirection: "column", alignItems: "stretch" }}>
            <strong style={{ fontSize: 18 }}>They&apos;re Not Mutually Exclusive</strong>
            <p style={{ marginTop: 8 }}>
          ...
          <div style={{ marginTop: 40, display: "flex", flexWrap: "wrap", gap: 10 }}>
            ...
            <Link href="/directory/categories/governance-consulting" className="rg-btn rg-btn-outline">Find Framework Consultants</Link>
            <Link href="/compare/colorado-vs-eu-ai-act" className="rg-btn rg-btn-outline">Colorado vs. EU AI Act &rarr;</Link>
          </div>
        </div>
      </div>
    </>
