    ...
    <>
      ...
      <div className="rg-page-head">
        <div className="rg-container" style={{ maxWidth: 1100 }}>
          ...
          <h1>Colorado AI Act vs. EU AI Act</h1>
          ...
          <div style={{ marginTop: 16, display: "flex", flexWrap: "wrap", gap: 8 }}>
            <Link href="/regulations/colorado-ai-act" className="rg-btn rg-btn-outline" style={{ fontSize: 13 }}>Colorado AI Act Guide &rarr;</Link>
            <Link href="/regulations/eu-ai-act" className="rg-btn rg-btn-outline" style={{ fontSize: 13 }}>EU AI Act Guide &rarr;</Link>
          </div>
        </div>
      </div>
      ...
      <div className="rg-page-body">
        <div className="rg-container" style={{ maxWidth: 1100 }}>
          ...
          {/* Summary cards */}
          <div className="rg-scard-grid" style={{ marginBottom: 48 }}>
            <div className="rg-scard" style={{ borderColor: "rgba(37,99,235,0.25)", background: "rgba(37,99,235,0.04)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                ...
                <span style={{ marginLeft: "auto", fontSize: 11, fontFamily: "monospace", color: "#60a5fa" }}>CO SB 24-205</span>
              </div>
            ...
            <div className="rg-scard" style={{ borderColor: "rgba(202,138,4,0.25)", background: "rgba(202,138,4,0.04)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                <Globe className="h-5 w-5" style={{ color: "#ca8a04", flexShrink: 0 }} aria-hidden="true" />
                <strong style={{ color: "#713f12" }}>EU AI Act</strong>
                <span style={{ marginLeft: "auto", fontSize: 11, fontFamily: "monospace", color: "#ca8a04" }}>Reg. 2024/1689</span>
              </div>
          ...
          {/* Comparison table */}
          <div className="rg-kicker" style={{ marginBottom: 20 }}>Detailed Comparison</div>
          ...
          <div className="rg-scard-grid" style={{ marginTop: 48 }}>
            <div>
              <div className="rg-kicker" style={{ marginBottom: 16 }}>Where They Align</div>
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12, fontSize: 14 }}>
                {[
                  ...
                  <li key={label} style={{ display: "flex", gap: 8 }}>
                    <Check className="h-4 w-4" style={{ color: "#16a34a", flexShrink: 0, marginTop: 2 }} aria-hidden="true" />
            ...
            <div>
              <div className="rg-kicker" style={{ marginBottom: 16 }}>Critical Differences</div>
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12, fontSize: 14 }}>
                {[
                  ...
                  <li key={label} style={{ display: "flex", gap: 8 }}>
                    <span style={{ color: "#dc2626", flexShrink: 0, marginTop: 2 }}>&ne;</span>
                    <span><strong>{label}</strong> {desc}</span>
                  </li>
                ))}
              </ul>
          ...
          {/* Compliance strategy */}
          <div className="rg-cta-banner" style={{ marginTop: 48, flexDirection: "column", alignItems: "stretch" }}>
            <strong style={{ fontSize: 18 }}>Dual Compliance Strategy</strong>
            <p style={{ marginTop: 8 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12, marginTop: 16 }}>
              {[
                ...
                <div key={item.step} className="rg-scard" style={{ background: "var(--rg-surface)" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                    <span style={{ display: "flex", width: 24, height: 24, alignItems: "center", justifyContent: "center", borderRadius: "50%", background: "var(--rg-primary)", color: "#fff", fontSize: 12, fontWeight: 700 }}>
                      {item.step}
                    </span>
          ...
          <div style={{ marginTop: 40, display: "flex", flexWrap: "wrap", gap: 10 }}>
            ...
            <Link href="/directory?regulation=eu-ai-act" className="rg-btn rg-btn-outline">Find EU AI Act Experts</Link>
