...
export const metadata: Metadata = {
  ...
  description: "Regulome terms of service — rules for using our website and tools.",
    ...
    <>
      ...
      <div className="container-narrow" style={{ padding: "var(--s-8) var(--s-7)" }}>
        <div className="prose-compliance">
          ...
          <p>By accessing or using Regulome (&ldquo;the Service&rdquo;), you agree to these Terms of Service. If you do not agree, do not use the Service.</p>
          ...
          <p>The content on this website — including regulation guides, blog posts, and glossary entries — is owned by Regulome. You may share content with attribution. You may not reproduce content for commercial purposes without written permission.</p>
          <h2>6. Limitation of Liability</h2>
          <p>To the maximum extent permitted by law, Regulome and its operators are not liable for any damages arising from your use of this website or reliance on its content, including but not limited to direct, indirect, incidental, or consequential damages.</p>
          ...
          <h2>8. Contact</h2>
          <p>Questions about these terms? Contact us at{" "}<a href="mailto:legal@regulome.io">legal@regulome.io</a>.</p>
        </div>
      </div>
    </>
  );
