    ...
    <>
      ...
      <div className="rg-page-head">
        <div style={{ maxWidth: 780, margin: "0 auto", padding: "0 40px" }}>
          ...
          <p style={{ marginTop: 8, fontSize: 13, color: "var(--rg-ink-dim)" }}>Last updated: April 13, 2026</p>
        </div>
      </div>
      ...
      <div className="rg-page-body">
        <div style={{ maxWidth: 780, margin: "0 auto", padding: "0 40px" }}>
          <div className="prose-compliance">
            ...
            <p><strong>The content on this website &mdash; including regulation guides, the compliance checker, glossary definitions, provider listings, and blog posts &mdash; is for informational purposes only and does not constitute legal advice.</strong></p>
            ...
            <p>The content on this website &mdash; including regulation guides, blog posts, and glossary entries &mdash; is owned by AI Compliance Hub. You may share content with attribution. You may not reproduce content for commercial purposes without written permission.</p>
