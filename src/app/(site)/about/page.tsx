    ...
    <>
      ...
      <section className="container-narrow" style={{ padding: "var(--s-8) var(--s-7)" }}>
        ...
        <p className="lede" style={{ color: "var(--ink)" }}>
          ...
          <span className="feature-flag">&star; Featured</span> providers pay to appear in the top slot on matched regulation pages &mdash; always clearly labeled. Matching is never sold below the line.
        </p>
