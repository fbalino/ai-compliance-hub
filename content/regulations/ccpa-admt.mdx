export const frontmatter = {
  ...
  shortName: "CCPA ADMT",
  description:
    "California's CCPA ADMT regulations give consumers the right to opt out of automated decision-making technology used for significant decisions affecting employment (including compensation), housing, finance, education, and healthcare — with mandatory pre-use notices, risk assessments, and appeal rights taking effect January 1, 2027.",
  jurisdiction: "US · California",
  status: "enacted",
  effectiveDate: "September 22, 2025 (OAL-approved); January 1, 2026 (general CCPA updates); January 1, 2027 (ADMT obligations)",
  enforcementDate: "January 1, 2027 (ADMT-specific); January 1, 2026 (risk assessments, cybersecurity audits)",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "The CPPA Board adopted the final ADMT rules on July 24, 2025, and they were approved by the Office of Administrative Law on September 22, 2025. General CCPA regulation updates took effect on January 1, 2026. The ADMT-specific obligations — including pre-use notice, opt-out rights, access rights, and appeal mechanisms — take effect on January 1, 2027. Businesses already using ADMT for significant decisions before that date must comply by January 1, 2027; businesses that begin using such ADMT after January 1, 2027 must comply before they deploy it. (April 1, 2027 was a deadline in an earlier rulemaking draft and was superseded by the final rules.)",
    },
    {
      question: "What are 'significant decisions' under the ADMT regulations?",
      answer:
        "Significant decisions are those that result in the provision or denial of financial or lending services, housing, education enrollment or opportunities, employment or independent contracting opportunities or compensation, or healthcare services. The employment category is broad — it covers hiring, allocation or assignment of work, compensation (including incentive compensation), promotion, demotion, and termination, not just hiring decisions. Advertising decisions were included in earlier drafts but were removed from the final regulations.",
    },
    {
...
- **Education** — enrollment, admissions decisions, student evaluations, financial aid determinations
- **Employment or independent contracting opportunities — or compensation** — hiring, allocation or assignment of work, compensation (including incentive compensation), promotion, demotion, performance evaluations, and termination
- **Healthcare** — treatment recommendations, insurance coverage, clinical triage

The final regulatory definition expressly covers "employment or independent contracting opportunities **or compensation**." This matters because it puts pay-setting, bonus, and other compensation decisions made with ADMT squarely in scope — the employment category is not limited to hiring.
...
- Made available to the CPPA — or the California Attorney General — upon request

In addition to producing assessments on request, businesses must **affirmatively submit information to the CPPA**. By **April 1, 2028**, a business must submit:

- An **attestation** that it conducted (and, where applicable, updated) the risk assessments required for processing activities initiated in **2026 and 2027**, and
- A **summary** of its risk assessment information

The submission covers fields such as a designated contact, the time period covered, the number of risk assessments conducted during that period, and the categories of personal information involved. The attestation must be signed by a member of executive management directly responsible for risk-assessment compliance. After this first cycle, the attestation and summary are submitted on a recurring annual basis — generally by April 1 of the year after the processing activity is initiated and the assessment is prepared. Businesses submit the summary and attestation, not the full underlying assessments, although the complete assessments must still be produced to the CPPA or Attorney General on request.
...
| **September 22, 2025** | OAL approves regulations; filed with Secretary of State (CPPA's public announcement is dated September 23, 2025) |
| **January 1, 2026** | General CCPA regulation updates effective; risk assessment and cybersecurity audit obligations begin |
| **January 1, 2027** | ADMT-specific obligations compliance deadline (pre-use notice, opt-out, access, appeal) |
| **April 1, 2028** | First deadline to submit risk assessment attestation + summary to the CPPA (covering 2026–2027 assessments); first cybersecurity audit due for largest businesses |
...
1. **Inventory your automated decision-making systems.** Identify every system that processes personal information and makes or substantially facilitates decisions about consumers. Map each system to the significant decision domains (finance, housing, education, employment/independent contracting/compensation, healthcare). Flag systems where human review is perfunctory or where AI outputs are routinely adopted without independent evaluation.
...
The CPPA Board adopted the final rules on July 24, 2025, and the OAL approved them on September 22, 2025. General CCPA regulation updates (risk assessments, cybersecurity audits) took effect January 1, 2026. ADMT-specific obligations — pre-use notice, opt-out, access, and appeal — must be met by January 1, 2027. Businesses already using ADMT for significant decisions before that date have until January 1, 2027 to comply; businesses that start using such ADMT after that date must comply before deploying it. (An earlier draft used an April 1, 2027 deadline, which the final rules superseded.)

**Do the ADMT regulations cover AI-powered advertising?**
No. Advertising decisions were included in earlier drafts but were removed from the final regulations. The ADMT obligations only apply to "significant decisions" affecting finance, housing, education, employment or independent contracting (including compensation), and healthcare. However, AI-driven advertising that processes personal information may still trigger risk assessment requirements under the broader CCPA regulatory package.
...
- [CPPA Official Rulemaking — ADMT and Risk Assessments](https://cppa.ca.gov/regulations/)
