export const frontmatter = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Yes, if they qualify as 'critical ICT third-party service providers' (CTPPs). The European Supervisory Authorities (ESAs) designate CTPPs and subject them to direct regulatory oversight. The ESAs published the first official list of 19 designated CTPPs on November 18, 2025, and active oversight of those providers is underway in 2026. Even non-critical AI vendors face contractual and monitoring requirements under DORA's third-party ICT risk management framework.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "A CTPP is an ICT service provider (including cloud providers, AI platform vendors, and data analytics firms) designated as critical by the European Supervisory Authorities based on the systemic importance of the services they provide to the financial sector. CTPPs are subject to direct supervisory oversight by an EU 'lead overseer' (EBA, ESMA, or EIOPA). The first list of 19 designated CTPPs was published on November 18, 2025 and includes Amazon Web Services EMEA, Microsoft Ireland, Google Cloud EMEA, IBM, Oracle, and SAP. The list is updated and re-published annually.",
    },
    {
...
- Systemic providers serving large portions of EU financial institutions are the most likely candidates for designation. The first CTPP list, published on November 18, 2025, already captures the major cloud and platform providers most commonly used to run AI workloads (Amazon Web Services EMEA, Microsoft Ireland, Google Cloud EMEA, Oracle, IBM, and SAP), so AI services delivered on top of these providers now sit within a supervised supply chain.
...
Where ICT services supporting critical or important functions are subcontracted, financial entities must also apply the dedicated subcontracting standards in **Delegated Regulation (EU) 2025/532**, which has applied since **July 22, 2025**. These require firms to assess and monitor the full subcontracting chain, set conditions for when such subcontracting is permitted, and preserve the right to terminate where subcontracting arrangements create unacceptable risk.
...
**The first list is now live.** On **November 18, 2025**, the ESAs published the first official list of **19 designated CTPPs**, drawn from the data financial entities reported in their registers of information. The named providers are: Accenture, Amazon Web Services EMEA, Bloomberg, Capgemini, Colt Technology Services, Deutsche Telekom, Equinix (EMEA), Fidelity National Information Services (FIS), Google Cloud EMEA, IBM, InterXion HeadQuarters, Kyndryl, LSEG Data & Risk, Microsoft Ireland Operations, NTT DATA, Oracle Nederland, Orange, SAP, and Tata Consultancy Services. Each designated CTPP must name an EU coordination point for its lead overseer and pay annual oversight fees, and the list is re-assessed and re-published by the ESAs annually. Active oversight of these providers is underway in 2026.

Designation is a data-driven annual exercise. Providers not yet on the list can also request designation through a voluntary opt-in process, which carries a non-refundable EUR 50,000 opt-in fee.
...
| **January 17, 2025** | First wave of DORA regulatory technical standards (RTS) and implementing technical standards (ITS) apply — including the major-incident reporting RTS/ITS (Delegated Regulation (EU) 2025/301 and Implementing Regulation (EU) 2025/302) |
| **July 22, 2025** | RTS on subcontracting ICT services supporting critical or important functions (Delegated Regulation (EU) 2025/532) applies |
| **November 18, 2025** | **ESAs publish the first official list of 19 designated CTPPs** (AWS EMEA, Microsoft Ireland, Google Cloud EMEA, Oracle, IBM, SAP, and others) |
| **2026** | Active oversight of designated CTPPs underway; first hard supervisory test of register-of-information submissions, with national authorities cross-referencing the data; financial institutions subject to TLPT continue assessment cycles |
...
- [EBA DORA resources](https://www.eba.europa.eu/regulation-and-policy/operational-resilience)
- [ESMA DORA resources](https://www.esma.europa.eu/policy-activities/digital-operational-resilience-act-dora)
